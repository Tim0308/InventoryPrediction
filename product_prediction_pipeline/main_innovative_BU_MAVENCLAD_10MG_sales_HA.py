...
# # Filter for Innovative Medicine BU and MAVENCLAD brand
# Innovative_BU_MAVENCLAD_sales_2023_to_2025 = filtered_df[
#     (filtered_df['Original BU'] == 'Innovative Medicine') &
#     (filtered_df['Brand Detail'] == 'MAVENCLAD 5MG/ML INJ 20ML 1\'S')
# ]

# print(Innovative_BU_MAVENCLAD_sales_2023_to_2025)

output_path_cleaned = 'Innovative_BU_MAVENCLAD_sales_2023_to_2025.xlsx'
# Innovative_BU_MAVENCLAD_sales_2023_to_2025.to_excel(output_path_cleaned, index=True)
...
def MAVENCLAD_sales_prediction(filtered_df):
    ...
    Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA = Innovative_BU_MAVENCLAD_sales_2023_to_2025[
        Innovative_BU_MAVENCLAD_sales_2023_to_2025['Sub Channel'] == 'HA Hospital'
    ]

    # Combine Year and Quarter for the pivot table columns
    Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA['YearQuarter'] = Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA['Year'].astype(str) + ' Q' + Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA['Quarter'].astype(str).str[-1]
    # print(Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA)

    hospital_list = Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA['SoldToCustomerName'].unique().tolist()
    ...
    Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA_filtered_top_sales['InvoiceDate'] = pd.to_datetime(Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA_filtered_top_sales['InvoiceDate'])
    # Sort and reset index for correct diff calculation
    Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA_filtered_top_sales = Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA_filtered_top_sales.sort_values(by='InvoiceDate').reset_index(drop=True)
    # Calculate the time difference between consecutive invoices
    Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA_filtered_top_sales['Time After Last Invoices'] = Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA_filtered_top_sales['InvoiceDate'].diff().dt.days

    # print(Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA_filtered_top_sales)
    ...
    for HA_hospital in HA_hospital_list:
        df_hospital = Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA_filtered_top_sales[
            (Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA_filtered_top_sales['SoldToCustomerName'] == HA_hospital) &
            (Innovative_BU_MAVENCLAD_sales_2023_to_2025_HA_filtered_top_sales['Brand Detail'] == 'MAVENCLAD 5MG/ML INJ 20ML 1\'S')
        ].copy()
        # Sort and reset index for correct diff calculation
    ...
    create_excel_from_prediction_summary(prediction_summary_list, output_path='predictions_MAVENCLAD_summary.xlsx')